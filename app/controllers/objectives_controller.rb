class ObjectivesController < ApplicationController
	...
	def create
		...
		if @objective.save
			Thread.new {
				message1 = "Cordiale #{@user.last_name}, il tuo coach #{@user.coach_user.first_name} ha pianificato un nuovo programma di allenamento. Visita la sezione 🎯Esercizi per ulteriori informazioni."
